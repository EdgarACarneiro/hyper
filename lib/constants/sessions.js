...
export const SESSION_FONT_SIZE_SET = 'SESSION_FONT_SIZE_SET';
export const SESSION_FONT_SIZE_INCR = 'SESSION_FONT_SIZE_INCR';
export const SESSION_FONT_SIZE_DECR = 'SESSION_FONT_SIZE_DECR';
