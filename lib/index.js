...
rpc.on('increase fontSize pane req', () => {
  store_.dispatch(uiActions.increasePaneFontSize());
});

rpc.on('decrease fontSize pane req', () => {
  store_.dispatch(uiActions.decreasePaneFontSize());
});
