...
rpc.on('session increase fontSize req', () => {
  store_.dispatch(sessionActions.increaseSessionFontSize());
});

rpc.on('session decrease fontSize req', () => {
  store_.dispatch(sessionActions.decreaseSessionFontSize());
});
